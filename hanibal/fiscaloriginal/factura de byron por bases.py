...
class account_invoice(osv.osv):
    ...
    _columns = {        
        ...
        'numerofac': fields.function(calcularnumerofac, string='Comprobante', type='char',size=50, store=True),
        'numeroret': fields.char('Retención'),
...
#        for t in identi_brw:
#            if t.amount_total:
#               if t.fiscal_invoice_pagos_line and t.amount_total < 1000 and t.type == 'in_invoice':
#                    raise osv.except_osv('Error!','No Puede Defirnir Formas de pago a Facturas Menores a 1000 Dolares')
#                     
#               if t.amount_total >= 1000 and not t.fiscal_invoice_pagos_line and t.type == 'in_invoice':
    ...
    def button_reset_taxes(self):
        ...
        for invoice in self:
            ...
            if invoice.type=='out_invoice':
                if invoice.journal_id and invoice.journal_id.tipodocumento_id:
                    flag1 = self.validar_punto_emision(invoice.id)
