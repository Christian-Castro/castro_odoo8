...
def get_amount_to_text(self, amount, lang, currency=""):
    if currency.upper() in ('USD', 'US', 'DOLARES', 'DOLARES ECUATORIANOS'):
        sufijo = 'M. N.'
        currency = 'DOLARES'
    else:
        sufijo = 'M. E.'
...
if __name__=="__main__":
    ...
    letra = amount_to_text_ec().amount_to_text_cheque(1500.25, '', 'M. N.')
    letra = amount_to_text(_ec).amount_to_text(1500.25)
    print letra.upper()
