...
def crear_hoja_libro_pdf(wb,title,flag,hojas):
    sheet = wb.active
    if (flag == 0):
...
def crear_encabezado(data,sheet_libromayor,alignment_title,fuente_cabecera):
    ...
    sheet_libromayor['I1'].border = thin_border_top_right
    sheet_libromayor['I2'].border = thin_border_right
    sheet_libromayor['I3'].border = thin_border_right
    sheet_libromayor['I4'].border = thin_border_right
    sheet_libromayor['I4'].border = thin_border_right
    sheet_libromayor['I5'].border = thin_border_buttonm_right
    ...
    sheet_libromayor['H1'].alignment = alignment_title.copy(wrapText=False, horizontal="center",
                                                            vertical="center")
    sheet_libromayor['H1'].font = fuente_cabecera.copy(bold=True, size=10, name="calibri", color='000000')
    sheet_libromayor['H1'] = 'Usuario:'

    sheet_libromayor['I1'].alignment = alignment_title.copy(wrapText=False, horizontal="left",
                                                            vertical="center")
    sheet_libromayor['I1'].font = fuente_cabecera.copy(bold=False, size=10, name="calibri", color='000000')
    sheet_libromayor['I1'] = data['usuario']
    ...
    sheet_libromayor.merge_cells('A2:I2')
    ...
    sheet_libromayor['G5'] = 'Fecha Emision: '

    sheet_libromayor['H5'].alignment = alignment_title.copy(wrapText=False, horizontal="center",
                                                            vertical="center")
    sheet_libromayor['H5'].font = fuente_cabecera.copy(bold=True, size=10, name="calibri", color='000000')


    sheet_libromayor['H5'] = datetime.now()
    sheet_libromayor.merge_cells('H5:I5')

    sheet_libromayor['G6'].alignment = alignment_title.copy(wrapText=False, horizontal="center",
                                                            vertical="center")
    sheet_libromayor['G6'].font = fuente_cabecera.copy(bold=True, size=10, name="calibri", color='000000')
    sheet_libromayor['G6'] = 'Saldo Total Inicial: '

    sheet_libromayor.merge_cells('G6:H6')

    sheet_libromayor['I6'].alignment = alignment_title.copy(wrapText=False, horizontal="left",
                                                          vertical="center")
    sheet_libromayor['I6'].font = fuente_cabecera.copy(bold=False, size=10, name="calibri", color='000000')
    sheet_libromayor['I6'] = data['inicial']
    sheet_libromayor['I6'].number_format = '0.00'
...
def cuerpo_reporte(sheet_libromayor,alignment_title,fuente_cabecera,data,hoja,hojas,hoja_cuerpo):
    ...
    sheet_libromayor['H' + str(hoja)].alignment = alignment_title.copy(wrapText=False, horizontal="right",
                                                                       vertical="center")
    sheet_libromayor['H' + str(hoja)].font = fuente_cabecera.copy(bold=True, size=10, name="calibri", color='000000')
    sheet_libromayor['H' + str(hoja)] = data['fecha']
    ...
    sheet_libromayor['F8'] = 'ESTRUCTURA'
    ...
    for i in asientos:
        ...
        sheet_libromayor['B' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                  horizontal="center",
                                                                                  vertical="center")
        sheet_libromayor['B' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=True, size=10, name="calibri",
                                                                             color='000000')
        ...
        for obj in asientos[i]:
            ...
            for l in obj:
                ...
                sheet_libromayor['A' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                          horizontal="left",
                                                                                          vertical="center")
                sheet_libromayor['A' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                                     name="calibri",
                                                                                     color='000000')
                ...
                sheet_libromayor['B' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                          horizontal="left",
                                                                                          vertical="center")
                sheet_libromayor['B' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                                     name="calibri",
                                                                                     color='000000')
                ...
                sheet_libromayor['C' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                          horizontal="left",
                                                                                          vertical="center")
                sheet_libromayor['C' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                                     name="calibri",
                                                                                     color='000000')
                ...
                sheet_libromayor['D' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                          horizontal="left",
                                                                                          vertical="center")
                sheet_libromayor['D' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                                     name="calibri",
                                                                                     color='000000')
                ...
                sheet_libromayor['E' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                          horizontal="left",
                                                                                          vertical="center")
                sheet_libromayor['E' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                                     name="calibri",
                                                                                     color='000000')
                ...
                sheet_libromayor['F' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10, name="calibri",
                                                                                     color='000000')
                sheet_libromayor['F' + str(hoja_cuerpo)] = str(l.seccion.codigo) +"/"+ str(l.jornada.codigo) +"/"+ str(l.curso.codigo)
                ...
                sheet_libromayor['G' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10, name="calibri",
                                                                                     color='000000')
                sheet_libromayor['G' + str(hoja_cuerpo)] = l.debit
                sheet_libromayor['G' + str(hoja_cuerpo)].number_format = '0.00'
                ...
                sheet_libromayor['H' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10, name="calibri",
                                                                                     color='000000')
                sheet_libromayor['H' + str(hoja_cuerpo)] = l.tax_amount
                sheet_libromayor['H' + str(hoja_cuerpo)].number_format = '0.00'
                ...
                sheet_libromayor['I' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10, name="calibri",
                                                                                     color='000000')
                sheet_libromayor['I' + str(hoja_cuerpo)] = saldo_actua
        ...
        sheet_libromayor['G' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                  horizontal="center",
                                                                                  vertical="center")
        sheet_libromayor['G' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=True, size=10,
                                                                             name="calibri", color='000000')
        sheet_libromayor['G' + str(hoja_cuerpo)] = "Saldo Mensual " + str(i) + " Total:"
        sheet_libromayor['G' + str(hoja_cuerpo)].border = thin_border
        sheet_libromayor['H' + str(hoja_cuerpo)].border = thin_border
        sheet_libromayor.merge_cells('G' + str(hoja_cuerpo) + ':H' + str(hoja_cuerpo))

        sheet_libromayor['I' + str(hoja_cuerpo)].alignment = alignment_title.copy(wrapText=False,
                                                                                  horizontal="right",
                                                                                  vertical="center")
        sheet_libromayor['I' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                             name="calibri", color='000000')
        sheet_libromayor['I' + str(hoja_cuerpo)] = saldo_actual_mes
        sheet_libromayor['I' + str(hoja_cuerpo)].number_format = '0.00'
        sheet_libromayor['I' + str(hoja_cuerpo)].border = thin_border
        hoja_cuerpo += 2
    ...
    sheet_libromayor['G' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=True, size=10,
                                                                         name="calibri", color='000000')
    sheet_libromayor['G' + str(hoja_cuerpo)] = "Saldo Total: "
    sheet_libromayor['G' + str(hoja_cuerpo)].border = thin_border
    sheet_libromayor['H' + str(hoja_cuerpo)].border = thin_border
    ...
    sheet_libromayor['I' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=False, size=10,
                                                                         name="calibri", color='000000')
    sheet_libromayor['I' + str(hoja_cuerpo)] = saldo_total
    sheet_libromayor['I' + str(hoja_cuerpo)].number_format = '0.00'
    sheet_libromayor['I' + str(hoja_cuerpo)].border = thin_border
...
def totalizado_cuentas(sheet_libromayor,hoja_cuerpo,alignment_title,fuente_cabecera,saldo_total):
    ...
    sheet_libromayor['G' + str(hoja_cuerpo)].font = fuente_cabecera.copy(bold=True, size=10,
                                                                         name="calibri", color='000000')
    sheet_libromayor['G' + str(hoja_cuerpo)] = "Saldo Final Total: "
    sheet_libromayor['G' + str(hoja_cuerpo)].border = thin_border
    sheet_libromayor['H' + str(hoja_cuerpo)].border = thin_border
    sheet_libromayor.merge_cells('G' + str(hoja_cuerpo) + ':H' + str(hoja_cuerpo))
...
def size_celdas(valor,sheet_libromayor):
    ...
    sheet_libromayor.column_dimensions['C'].width = 10.00
    sheet_libromayor.column_dimensions['B'].width = 14.00
    sheet_libromayor.column_dimensions['D'].width = 25.00
    sheet_libromayor.column_dimensions['E'].width = 29.64
    sheet_libromayor.column_dimensions['F'].width = 18.09
    sheet_libromayor.column_dimensions['G'].width = 11.91
    sheet_libromayor.column_dimensions['H'].width = 11.55
