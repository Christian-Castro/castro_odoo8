...
* Monthly Turnover (Graph)
    ...
    'data': [
        ...
        'analisis_atencion_pedidos_view.xml',
        'analisis_web_rep_trp_pesos_view.xml',
        'analisis_rotacion_cartera_view.xml',
        'analisis_rotacion_inventario_usd_view.xml',
        'analisis_disponibilidad_inmediata.xml'
